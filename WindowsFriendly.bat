...
set /p answer=Have you answered all the forensics questions?[y/n]: 
	if /I {%answer%}=={y} (
		...
		echo Return after answering them.
		pause
		exit
	)
...
:menu
	cls
	echo "    __  __________   _______ ___ "
	echo "   /  |/  / ____/ | / / ___//   |"
	echo "  / /|_/ / __/ /  |/ /\__ \/ /| |"
	echo " / /  / / /___/ /|  /___/ / ___ |"
...
:userProp
	...
	::wmic useraccount command allows the management of user accounts through the Windows Management Instrumentation Command line
	:: to see a list of all user accounts run: "wmic useraccount get name, fullname"
